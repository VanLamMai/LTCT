...
void XuLyMenu(int menu, DaySo a, int& n)
{
	...
	case 4:
		...
		XoaDauDay(a, n);
		cout << "\nKich thuoc mang ket qua: n = " << n;
		cout << "\nDay so sau khi xoa ket qua gia tri dau:\n";
		XuatMang(a, n);
		break;
	case 5:
		cout << "\n5. Cai phan tu dau day roi chen vao cuoi day";
		...
		CatDau_ChenCuoi(a, n);
		cout << "\nKich thuoc mang ket qua: n = " << n;
		cout << "\nDay so ket qua sau khi cat ket qua gia tri dau roi chen vao cuoi day:\n";
		XuatMang(a, n);
		break;
	case 6:
		cout << "\n6. Thay the cac gia tri x trong a bang gia tri y";
		cout << "\nNhap gia tri x can thay the: x = ";
		cin >> x;
	...
	case 7:
		...
		break;
	case 8:
		cout << "\n8. Sap day theo yeu cau: DuongTang - Am Giam - Khong";
		cout << "\nDay so hien hanh:\n";
		XuatMang(a, n);
		Sap_DuongTang_AmGiam_Khong(a, n);
		cout << "\nDay so sau khi sap xem theo yeu cau:\n";
		XuatMang(a, n);
		break;
	}
	_getch();
