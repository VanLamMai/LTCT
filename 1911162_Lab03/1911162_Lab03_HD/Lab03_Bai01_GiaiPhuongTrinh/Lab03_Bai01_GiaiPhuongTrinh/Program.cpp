...
//Định nghĩa hằng số và dữ liệu kiểu mới
...
float NhapMotSoKhacKhong()
{
	...
	//Gán giá trị số cho hàm và trở về nơi gọi hàm
	return so;
}
...
float NhapMotSoKhacKhong_1()
{
	float so = 0; //Khai báo biến để lưu số thực
                  //Thực hiện việc kiểm tra giá trị nhập
	              //Nếu giá trị nhập bằng 0 thù yêu cầu nhập lại
	while (so == 0)
	{
		cout << endl << "Nhap mot so thuc (khac 0): ";
		cin >> so;
